...
#%%
### PREPARE DATASET
data = load_from_disk("/home/ubuntu/24Spr_CMagee_LanguageDetection/Code/test_data_subset")
...
training_args = Seq2SeqTrainingArguments(
    output_dir="./whisper-tiny-capstone2",  # change to a repo name of your choice
...
trainer.push_to_hub("whisper-tiny-capstone2")
